...
public class SplineChart03View extends DemoView {
	...
	public void setChartLabels(LinkedList<String> labels) {
		/*
		 * chartLabels(); this.chartData = chartData;
		 */
		this.labels = labels;
	}
	...
	private void chartRender() {
		try {
			...
			// 设置图的背景色
			/*
			 * chart.setApplyBackgroundColor(true); chart.setBackgroundColor(
			 ...
			 * chart.extPointClickRange(5); chart.showClikedFocus();
			 */
	...
	private void chartDataSet() {
		...
		/*
		 * chartData.add(dataSeries2); chartData.add(dataSeries3);
		 */
	}
