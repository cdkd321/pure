...
public class PureProgress3 extends LinearLayout{
	...
	public PureProgress3(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		progress_tv.setPadding((int)(getWidth()*((mProgress-0.2)/0.4))-DeviceConfiger.dp2px(30), 0, 0, 0);
	...
	private void initView(Context context) {
		...
		layout = (LinearLayout) inflater.inflate(R.layout.progress_3, this);
